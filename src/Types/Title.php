...
{
    const HOOK = 'elementor/element/heading/section_title/before_section_start';

    const CONTROL_NAME = '_category_title';

    private string $elementorHook = 'elementor/element/heading/section_title/before_section_start';
